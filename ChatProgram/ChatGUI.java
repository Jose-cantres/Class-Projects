		...
		do {
			try {
				...
				if (inPacket != null) {
					...
					if (StartGUI.storingTable.containsKey(ipAndPort)) {
						chat = StartGUI.storingTable.get(ipAndPort);
						chatArea.append("Receiver: " + message + "\n");
						chat.setVisible(true);
					} else {
						chat = new ChatGUI(mySocket, ip, port);
						StartGUI.storingTable.put(ipAndPort, chat);
						chatArea.append("Receiver: " + message + "\n");
						chat.setVisible(true);
					}
				}
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (send.isEnabled()) {
			...
			if (o == send) {
				...
				chatArea.append("User: " + messageField.getText() + "\n");
